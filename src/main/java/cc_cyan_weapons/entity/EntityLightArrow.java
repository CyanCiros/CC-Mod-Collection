...
public class EntityLightArrow extends EntityArrow implements IThrowableEntity {
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityLightArrow(final World world) {
		super(world);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	}

	public EntityLightArrow(final World world, final double x, final double y, final double z) {
		super(world);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityLightArrow(final World world, final EntityLivingBase entityLivingBase,
	...
	public EntityLightArrow(final World world, final EntityLivingBase entityLivingBase, final float par3) {
		super(world);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = entityLivingBase;
