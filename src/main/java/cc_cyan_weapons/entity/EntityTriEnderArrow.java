...
public class EntityTriEnderArrow extends EntityArrow implements IThrowableEntity {
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityTriEnderArrow(final World world) {
		super(world);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	}

	public EntityTriEnderArrow(final World world, final double x, final double y, final double z) {
		super(world);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityTriEnderArrow(final World world, final EntityLivingBase entityLivingBase,
	...
	public EntityTriEnderArrow(final World world, final EntityLivingBase entityLivingBase, final float par3) {
		super(world);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = entityLivingBase;
				...
				if (movingobjectposition.entityHit != null) {
					...
					if (movingobjectposition.entityHit.attackEntityFrom(damagesource, k)) {
						if (movingobjectposition.entityHit instanceof EntityLivingBase) {
							...
							if (Config.triEnderBowHitEntityEffect) {
								// entitylivingbase.setFire(9);

								// final int y = (int)
								// (entitylivingbase.prevPosY
								// + (entitylivingbase.posY -
								// entitylivingbase.prevPosY)
								// + 1.62D - entitylivingbase.yOffset);
								//
								// entitylivingbase
								// .addVelocity(
								// -MathHelper
								// .sin(entitylivingbase.rotationYaw * 3.141593F
								// / 180.0F)
								// * y * 0.15F / 8.0D,
								// 0.1D,
								// MathHelper
								// .cos(entitylivingbase.rotationYaw * 3.141593F
								// / 180.0F)
								// * y * 0.15F / 8.0D);
							}
						}
