...
public class ItemLightNetherSword extends ItemSword {
	public ItemLightNetherSword(final ToolMaterial toolMaterial, final String name) {
		super(toolMaterial);
	...
	public ItemStack onItemRightClick(final ItemStack itemStack, final World world, final EntityPlayer entityPlayer) {
		if (Config.lightNetherSwordRightClickEffect) {
	...
	public boolean hitEntity(final ItemStack itemStack, final EntityLivingBase entity1,
		...
		if (Config.lightNetherSwordHitEntityEffect) {
