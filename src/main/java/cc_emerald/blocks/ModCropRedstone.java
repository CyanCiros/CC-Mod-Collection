...
public class ModCropRedstone extends BlockCrops {
	@SuppressWarnings("unused")
	public ModCropRedstone(final String name, final Item itemSeed, final Item itemDrop) {
		super();
