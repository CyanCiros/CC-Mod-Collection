...
public class ModCropQuartz extends BlockCrops {
	@SuppressWarnings("unused")
	public ModCropQuartz(final String name, final Item itemSeed, final Item itemDrop) {
		super();
