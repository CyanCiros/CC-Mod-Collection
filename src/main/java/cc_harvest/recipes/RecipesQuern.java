...
public class RecipesQuern {
	private static final RecipesQuern smeltingBase = new RecipesQuern();
	...
	private RecipesQuern() {
		this.addRecipeItem(Items.wheat,
				new ItemStack(ModItems.flourItem, 1, 0), 0.0F);
		this.addRecipeItem(ModItems.riceItem, new ItemStack(ModItems.flourItem,
				1, 0), 0.0F);
		this.addRecipeItem(Items.potato,
				new ItemStack(ModItems.flourItem, 1, 0), 0.0F);
		this.addRecipeItem(ModItems.ryeItem, new ItemStack(ModItems.flourItem,
				1, 0), 0.0F);
		this.addRecipeItem(ModItems.oatsItem, new ItemStack(ModItems.flourItem,
				1, 0), 0.0F);
		this.addRecipeItem(ModItems.barleyItem, new ItemStack(
				ModItems.flourItem, 1, 0), 0.0F);
	}

	public static RecipesQuern smelting() {
		return smeltingBase;
	}
