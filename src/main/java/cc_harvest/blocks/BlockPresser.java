...
public class BlockPresser extends BlockContainer {
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

	public BlockPresser(final String name) {
		super(Material.wood);
	...
	public boolean onBlockActivated(final World world, final BlockPos pos, final IBlockState state,
		...
		if (tileentity instanceof TileEntityPresser) {
			player.openGui(CCModCollection.instance, GuiHandler.GuiPresser, world, pos.getX(), pos.getY(), pos.getZ());
		}
