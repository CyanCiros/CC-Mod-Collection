...
public class BlockStorageBox extends BlockContainer {
	...
	protected BlockStorageBox(final String name) {
		super(Material.wood);
	...
	public boolean onBlockActivated(final World world, final BlockPos pos, final IBlockState state,
		...
		if (tileentity instanceof TileEntityStorageBox) {
			player.openGui(CCModCollection.instance, GuiHandler.GuiStorageBox, world, pos.getX(), pos.getY(),
					pos.getZ());
		}
