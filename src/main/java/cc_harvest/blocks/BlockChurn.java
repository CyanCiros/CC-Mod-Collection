...
public class BlockChurn extends BlockContainer {
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

	public BlockChurn(final String name) {
		super(Material.wood);
	...
	public boolean onBlockActivated(final World world, final BlockPos pos, final IBlockState state,
		...
		if (tileentity instanceof TileEntityChurn) {
			player.openGui(CCModCollection.instance, GuiHandler.GuiChurn, world, pos.getX(), pos.getY(), pos.getZ());
		}
