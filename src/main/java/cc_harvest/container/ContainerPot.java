...
import cc_harvest.manager.CraftingManagerPot;
import cc_harvest.slot.SlotPot;
...
public class ContainerPot extends Container {
	...
	public TileEntityPot tileEntity;

	private final World world;

	public ContainerPot(final InventoryPlayer inventoryPlayer, final TileEntityPot tileEntityPot, final World world) {
		this.tileEntity = tileEntityPot;

		this.world = world;

		this.addSlotToContainer(new SlotPot(inventoryPlayer.player, this.craftMatrix, this.craftResult, 0, 124, 35));
	...
	public void onCraftMatrixChanged(final IInventory iInventory) {
		this.craftResult.setInventorySlotContents(0,
				CraftingManagerPot.getInstance().findMatchingRecipe(this.craftMatrix, this.world));
	}
