...
public class GuiChurn extends GuiContainer {
	private final TileEntityChurn churnInventory;
	private static final ResourceLocation resourceLocation = new ResourceLocation(CCHarvest.MODID, "textures/gui/churn.png");

	public GuiChurn(final InventoryPlayer inventoryPlayer, final TileEntityChurn tileEntityChurn) {
		super(new ContainerChurn(inventoryPlayer, tileEntityChurn));

		this.churnInventory = tileEntityChurn;
	}

	@Override
	protected void drawGuiContainerForegroundLayer(final int par1, final int par2) {
		this.fontRendererObj.drawString(I18n.format("Churn", new Object[0]), 66, 6, 4210752);
	...
	protected void drawGuiContainerBackgroundLayer(final float par1, final int par2, final int par3) {
		...
		final int xTimer = this.churnInventory.getCookProgressScaled(24);
