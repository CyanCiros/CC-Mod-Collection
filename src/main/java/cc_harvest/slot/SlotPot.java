...
public class SlotPot extends Slot {
	private final InventoryCrafting craftMatrix;
	private final EntityPlayer thePlayer;
	private int amountCrafted;

	public SlotPot(final EntityPlayer player, final InventoryCrafting craftingInventory, final IInventory inventory,
			final int slotIndex, final int xPosition, final int yPosition) {
	...
	public void onPickupFromSlot(final EntityPlayer player, final ItemStack stack) {
		...
		final ItemStack[] aitemstack = CraftingManagerPot.getInstance().func_180303_b(this.craftMatrix,
				player.worldObj);
