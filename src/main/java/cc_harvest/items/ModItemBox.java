...
public class ModItemBox extends Item {
	private final ModItemSeeds seeds;
	private final Random random;

	public ModItemBox(final String name, final ModItemSeeds seeds) {
	...
	public ItemStack onItemRightClick(final ItemStack itemStack, final World world, final EntityPlayer entityPlayer) {
		...
		final ItemStack newItemStack = new ItemStack(this.seeds, this.random.nextInt(3) + 4);
